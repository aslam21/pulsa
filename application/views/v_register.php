...
<head>
  ...
  <title>Event Lampung | Log in</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url(); ?>assets/index2.html"><b>Event</b>Saya</a>
    </div>
    <!-- /.login-logo -->
    ...
    <div class="login-box-body">
      <p class="login-box-msg">www.BigSourceProject.com</p>
      ...
      <form action="<?php echo base_url().'login/register_aksi' ?>" method="post">
        ...
        <div class="form-group has-feedback">
          <input type="text" class="form-control" placeholder="Nomor Hape" name="nomer_hape">
          <span class="glyphicon glyphicon-earphone form-control-feedback"></span>
        </div>
        <?php echo form_error('nomer_hape'); ?>
