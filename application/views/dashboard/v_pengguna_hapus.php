			...
			<div class="col-lg-6">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<p><b><?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dihapus. dan semua event yang ditulis oleh <b><?php echo $pengguna_hapus->pengguna_nama; ?></b> akan dipindahkan ke ?</p>
						...
						<form method="post" action="<?php echo base_url('dashboard/pengguna_hapus_aksi') ?>">
							...
							<div class="box-footer">
								<input type="submit" class="btn btn-success" value="Hapus Pengguna & Pindahkan event">
							</div>
						</form>
